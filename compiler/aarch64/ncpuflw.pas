...
procedure taarch64tryfinallynode.pass_generate_code;
  ...
  begin
    ...
    tcpuprocinfo(current_procinfo).add_finally_scope(trylabel,endtrylabel,
      current_asmdata.RefAsmSymbol(finalizepi.procdef.mangledname,AT_FUNCTION),catch_frame,current_asmdata.CurrObjData);
...
procedure taarch64tryexceptnode.pass_generate_code;
  ...
  begin
    ...
    tcpuprocinfo(current_procinfo).add_except_scope(trylabel,exceptlabel,endexceptlabel,filterlabel,current_asmdata.CurrObjData);
